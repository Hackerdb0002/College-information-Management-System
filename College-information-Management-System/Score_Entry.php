    					...
    					<select name="sudenttxt" style="width: 200px;">
                            ...
                            <?php
								...
								while($row=mysqli_fetch_array($student_name)){
									 if($row['stu_name']==$rs_upd['stu_name'])
								   		$iselect="selected";
									else
										$iselect="";
								?>
					...
					<div class="select_style">
                            ...
                            <?php
							   ...
							   while($row=mysqli_fetch_array($fac_name)){
								    if($row['faculties_ name']==$rs_upd['faculties_name'])
								   		$iselect="selected";
									else
										$iselect="";
								?>
					...
					<div class="select_style">
                            ...
                            <?php
							   ...
							   while($row=mysqli_fetch_array($subject)){
								   if($row['sub_name']==$rs_upd['sub_name'])
								   		$iselect="selected";
									else
										$iselect="";
							?>
    ...
    <div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-star-empty"></span> Score's Entry Form</h1></div>
            ...
            <div class="teacher_bday_box" style="margin-left: 0px;">
                ...
                <div class="teacher_note_pos">
                	<input class="form-control" type="text" name="midermtxt" id="textbox" placeholder='Passing Year' />
                </div><br>
