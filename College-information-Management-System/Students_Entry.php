...
<div class="container_form">
    <form method="post">
				...
				<div class="teacher_division_pos">
					<input type="text" name="division" class="form-control" value="<?php echo $rs_upd['division'];?> " />
				</div><br>
				<!--
				...
				<div class="teacher_bday_box">
					<span class="p_font">Acadmic Year: </span>&nbsp;&nbsp;&nbsp;
...
<div class="container_form">
    <form method="post">
				...
				<div class="teacher_bdayPlace_pos">
					<input type="text" name="divitxt" class="form-control" placeholder="division " />
				</div><br>
				<!--
				<div class="teacher_radio_pos">
