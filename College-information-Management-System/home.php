...
<title>College Information management system made by Dhiraj bhokare..</title>
</head>

<body>
	<div class="panel panel-default">
  		<div class="panel-heading"><h1>College Information Management System</h1></div>
                <div class="panel-body"><br><br>
        <div>
            <img src="images/download.jpg" width="855" style="text-align: center;" height="308" onmousedown="return false;"  />
        </div><br><br>
        <div class="middle_text">
            <p><strong>College of computer science and information technology Latur</strong></p>
        </div>
